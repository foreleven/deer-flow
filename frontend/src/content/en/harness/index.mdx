...
<Callout type="info" emoji="📦">
  The DeerFlow Harness Python package will be published as <code>deerflow</code>. It is not released yet, so installation is currently <strong>Coming Soon</strong>.
</Callout>
